  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-80 bg-cover bg-center bg-no-repeat" style={{
        backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.4)), url("https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&q=80")`
      }}>
        <Navbar />
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white px-4">
            ...
            <p className="text-xl max-w-3xl mx-auto animate-fade-in" style={{ animationDelay: '200ms' }}>
              Get in touch with Kings Liquor for all your agricultural needs
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
                ...
                <CardContent className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Coordinates: -6.77235, 39.24248</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">+255 716 852 420</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">agrofarming@kings.co.tz</p>
                    </div>
                  </div>
              ...
              <Card className="shadow-lg">
                <CardHeader>
                  <CardTitle className="text-xl text-green-700">Why Choose Kings Liquor?</CardTitle>
                </CardHeader>
                <CardContent>
